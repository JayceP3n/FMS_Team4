...
function preload() {
  ...
  resetButtonImage = loadImage('images/Reset.png');
  nextButtonImage = loadImage('images/Next.png');
}
...
function setup() {
  ...
  startOverButton = createImg('images/Reset.png', 'restart');
  ...
  continueButton = createImg('images/Next.png', 'next level');
